...
{
    [Activity(Label = "CrossAppStudy notification", MainLauncher = false, Icon = "@drawable/icon", Theme = "@android:style/Theme.Material")]
    class NotificationActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            var spinner_style = Android.Resource.Layout.SimpleSpinnerDropDownItem;

            styleSpinner.Adapter = ArrayAdapter.CreateFromResource(this, Resource.Array.notification_style, spinner_style);
            prioritySpinner.Adapter = ArrayAdapter.CreateFromResource(this, Resource.Array.notification_priority, spinner_style);
            categorySpinner.Adapter = ArrayAdapter.CreateFromResource(this, Resource.Array.notification_category, spinner_style);
            visibilitySpinner.Adapter = ArrayAdapter.CreateFromResource(this, Resource.Array.notification_visibility, spinner_style);
            ...
            launchBtn.Click += delegate
            {
                ...
                Notification.Builder builder = new Notification.Builder(this)
                    .SetContentTitle("CrossApp Notification")
                ...
                Intent secondIntent = new Intent(this, typeof(FromNotificationActivity));
                ...
                stackBuilder.AddParentStack(Java.Lang.Class.FromType(typeof(FromNotificationActivity)));
